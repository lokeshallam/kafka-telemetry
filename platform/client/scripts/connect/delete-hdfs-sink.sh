...
echo "Deleting hdfssink connector"
curl -k $BASIC_AUTH --header "Content-Type: application/json" -X DELETE $KAFKA_CONNECT_URL/connectors/hdfssink
echo "Deleted hdfssink connector"